        ...
        <div className="mx-auto max-w-7xl px-6 h-18 flex items-center justify-between">
              ...
              {navigationItems.map((item) => (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive(item.href) && 'text-sky-600 dark:text-sky-400 bg-sky-50 dark:bg-sky-900/20'
                  )}
                >
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <DropdownMenu>
              ...
              >
                {languages.map((lang) => (
                  <DropdownMenuItem key={lang.code} className="inline-flex items-center gap-2">
                    <span>{lang.flag}</span>
                    {lang.name}
                  </DropdownMenuItem>
                ))}
            ...
            <DropdownMenu>
              ...
              >
                {helpItems.map((item) => (
                  <DropdownMenuItem key={item.href} className="inline-flex items-center gap-2">
                  ...
                  <div className="pt-2">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        {languages.map((lang) => (
                          <DropdownMenuItem key={lang.code} onClick={() => setIsMenuOpen(false)}>
