      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200 text-left">
            ...
            <p className="text-gray-700 italic mb-4">&ldquo;ProofOfFit has revolutionized our hiring process. The AI matching is incredibly accurate, and the compliance features give us peace of mind.&rdquo;</p>
            <p className="font-semibold text-gray-900">- Jane Doe, HR Director at Acme Corp</p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200 text-left">
            <Star className="h-5 w-5 text-yellow-500 mb-4" />
            <p className="text-gray-700 italic mb-4">&ldquo;We&apos;ve cut down our time-to-hire by 30% and significantly improved candidate quality. ProofOfFit is a game-changer!&rdquo;</p>
