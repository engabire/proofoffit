...
export function PerformanceDashboard({ className }: PerformanceDashboardProps) {
    const { metrics, score, recommendations, generateReport, sendReport } =
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-2">
                            ...
                            <Badge
                                variant={getMetricStatus("lcp", metrics.lcp)
                                        .status === "good"
                                    ? "default"
                                    : "destructive"}
                            >
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-2">
                            ...
                            <Badge
                                variant={getMetricStatus("fid", metrics.fid)
                                        .status === "good"
                                    ? "default"
                                    : "destructive"}
                            >
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-2">
                            ...
                            <Badge
                                variant={getMetricStatus("cls", metrics.cls)
                                        .status === "good"
                                    ? "default"
                                    : "destructive"}
                            >
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-1">
                            ...
                            <div className="text-sm text-gray-600">
                                Bandwidth:{" "}
                                {formatMetric(metrics.bandwidth, "Mbps")}
                            </div>
                        </div>
                    </CardContent>
                </Card>
