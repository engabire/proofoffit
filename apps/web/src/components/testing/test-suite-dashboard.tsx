...
export function TestSuiteDashboard(
    { onTestComplete }: TestSuiteDashboardProps,
) {
                        ...
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="flex items-center gap-2">
                                        {getTestIcon(
                                            suite.tests[0]?.category || "unit",
                                        )}
                                        <CardTitle>{suite.name}</CardTitle>
                                    </div>
                                    <Badge
                                        variant={getSuiteStatusColor(
                                            suite.status,
                                        )}
                                    >
                                        {suite.status}
            ...
            {stats.failed > 0 && (
                <Alert className="border-red-200 bg-red-50">
                    ...
                    <AlertDescription className="text-red-700">
                        {stats.failed}{" "}
                        test(s) failed. Please review the test results and fix
                        the issues.
                    </AlertDescription>
                </Alert>
            )}
            ...
            {stats.passed === stats.total && stats.total > 0 && (
                <Alert className="border-green-200 bg-green-50">
                    ...
                    <AlertDescription className="text-green-700">
                        All {stats.total}{" "}
                        tests have passed successfully. Your application is
