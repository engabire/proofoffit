...
export function EnhancedEnterpriseLogin({
  ...
  const [emailSentType, setEmailSentType] = useState<
    "verification" | "magic_link" | null
  >(null);
            ...
            <CardContent className="p-8 text-center">
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-3">
                  ...
                  <Button
                    onClick={emailSentType === "verification"
                      ? handlePasswordAuth
                      : handleMagicLink}
                    disabled={loading}
                    className="flex-1"
          ...
          <CardContent className="space-y-6">
            ...
            {isEnterprise && (
              <Alert>
                ...
                <AlertDescription>
                  Enterprise domain detected. You may be eligible for SSO
                  authentication.
                </AlertDescription>
              </Alert>
            )}
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span
                      className={getPasswordStrengthColor(
                        securityChecks.passwordStrength,
                      )}
                    >
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      className={`h-2 rounded-full transition-all ${
                        securityChecks.passwordStrength < 2
                          ? "bg-red-500"
                          : securityChecks.passwordStrength < 4
                          ? "bg-yellow-500"
                          : "bg-green-500"
                      }`}
                      style={{
                        width: `${
                          (securityChecks.passwordStrength / 5) * 100
                        }%`,
                      }}
                    />
                  </div>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                ...
                <button
                  onClick={() =>
                    router.push(
                      mode === "signup" ? "/auth/signin" : "/auth/signup",
                    )}
