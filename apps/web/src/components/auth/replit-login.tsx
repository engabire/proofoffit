...
export function ReplitLogin({ 
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gray-100 p-12 flex-col justify-between">
        {/* Header */}
        <div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="bg-white rounded-lg p-4 shadow-sm">
              ...
              <p className="text-sm text-gray-700 font-medium">All professions, all backgrounds</p>
            </div>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm">
              ...
              <p className="text-sm text-gray-700 font-medium">Healthcare to tech - everyone welcome</p>
            </div>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm">
              <div className="w-full h-32 bg-gradient-to-br from-orange-100 to-orange-200 rounded-lg mb-3 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-600">Culinary</div>
                </div>
              </div>
              <p className="text-sm text-gray-700 font-medium">Blue collar, white collar, service - all valued</p>
            </div>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm">
              ...
              <p className="text-sm text-gray-700 font-medium">Evidence-based hiring for everyone</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-700">Evidence-first hiring methodology</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-5 h-5 bg-green-600 rounded-full flex items-center justify-center">
                <div className="w-2 h-2 bg-white rounded-full" />
              </div>
              <span className="text-gray-700">Secure, verified credentials</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-5 h-5 bg-purple-600 rounded-full flex items-center justify-center">
                <Briefcase className="h-3 w-3 text-white" />
              </div>
              <span className="text-gray-700">Built for modern teams</span>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-xl shadow-lg p-8">
            {/* Title */}
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Sign in to ProofOfFit</h1>
            <p className="text-gray-600 mb-8">Sign in to access your applications and portfolio.</p>
            ...
            <div className="mt-6 flex items-start gap-2 text-sm text-gray-500">
              ...
              <p>Access your applications, manage your portfolio, and showcase your proven capabilities.</p>
            </div>
          </div>
        </div>
      </div>
