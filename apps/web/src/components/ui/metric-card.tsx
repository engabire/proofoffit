...
export function MetricCard({
  ...
  const variantClasses = {
    ...
    success: "bg-gradient-to-br from-proof-green/5 to-proof-blue/5 border-proof-green/20",
    warning: "bg-gradient-to-br from-proof-orange/5 to-proof-purple/5 border-proof-orange/20",
    info: "bg-gradient-to-br from-proof-blue/5 to-proof-purple/5 border-proof-blue/20"
  };
