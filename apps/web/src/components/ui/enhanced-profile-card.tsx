                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <Badge
                                    className={getPlanColor(profile.plan)}
                                    data-testid={`badge-plan-${profile.id}`}
                                >
                                    {profile.plan}
                                </Badge>
                            </div>
                            ...
                            {profile.headline && (
                                <p
                                    ...
                                    data-testid={`text-profile-headline-${profile.id}`}
                                >
                                    {profile.headline}
                                </p>
                            )}
                            ...
                            <div className="flex items-center gap-4 text-sm text-muted-foreground">
                                <div className="flex items-center gap-1">
                                    ...
                                    <span
                                        data-testid={`text-profile-role-${profile.id}`}
                                    >
                                ...
                                {profile.location && (
                                    <div className="flex items-center gap-1">
                                        ...
                                        <span
                                            data-testid={`text-profile-location-${profile.id}`}
                                        >
                                            {profile.location}
                                        </span>
                                    </div>
                ...
                <CardContent className="space-y-4">
                    {profile.bio && (
                        <div>
                            ...
                            <p
                                ...
                                data-testid={`text-profile-bio-${profile.id}`}
                            >
                                {profile.bio}
                            </p>
                        </div>
                    ...
                    <div className="text-xs text-muted-foreground">
                        ...
                        {profile.updatedAt !== profile.createdAt && (
                            <span
                                className="ml-2"
                                data-testid={`text-profile-updated-${profile.id}`}
                            >
