...
Agile Cockpit`,
        type: 'monthly',
        enabled: false,
        recipients: ['team@company.com', 'manager@company.com', 'executives@company.com']
      }
    ]
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) => setSettings(prev => ({ ...prev, alertNotifications: e.target.checked }))}
                className="rounded border-gray-300"
              />
            ...
            <label className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) => setSettings(prev => ({ ...prev, monthlySummary: e.target.checked }))}
                className="rounded border-gray-300"
              />
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              { template: 'Daily Sprint Update', sent: '2 hours ago', status: 'delivered', recipients: 5 },
              { template: 'Weekly Sprint Report', sent: '1 day ago', status: 'delivered', recipients: 8 },
              { template: 'Alert Notification', sent: '3 days ago', status: 'delivered', recipients: 3 },
              { template: 'Daily Sprint Update', sent: '4 days ago', status: 'failed', recipients: 0 }
            ].map((email, index) => (
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex space-x-1 bg-gray-100 rounded-lg p-1">
        {[
          { key: 'templates', label: 'Templates', icon: <Mail className="w-4 h-4" /> },
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Send test emails and enable the notifications you want</p>
              </div>
            </div>
          </div>
        </CardContent>
