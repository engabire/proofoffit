...
export function AnalyticsReviewDashboard({
        ...
        const mockInsights: AnalyticsInsight[] = [
            {
                ...
                description:
                    "Page views increased by 12.5% compared to previous period",
                severity: "low",
            ...
            },
            {
                ...
                description:
                    "Bounce rate on /landing is 67%, significantly higher than average",
                severity: "medium",
            ...
            },
            {
                ...
                description:
                    "Mobile users have 23% lower conversion rate than desktop users",
                severity: "medium",
            ...
            },
            {
                ...
                description:
                    "JavaScript errors increased by 150% in the last hour",
                severity: "high",
    ...
    const getInsightIcon = (type: string, severity: string) => {
        if (
            type === "alert" || severity === "high" || severity === "critical"
        ) {
