...
function LivingProofCanvas() {
  ...
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute -top-24 -left-24 h-80 w-80 rounded-full blur-3xl opacity-25 bg-gradient-to-br from-indigo-300 via-sky-200 to-cyan-200 dark:from-indigo-600/30 dark:via-sky-500/25 dark:to-cyan-500/25" />
      <div className="absolute -bottom-32 -right-32 h-96 w-96 rounded-full blur-3xl opacity-25 bg-gradient-to-tr from-fuchsia-200 via-rose-200 to-amber-200 dark:from-fuchsia-500/25 dark:via-rose-500/25 dark:to-amber-400/25" />
  ...
  return (
    ...
    >
      <div className="mb-2 flex items-center justify-between text-xs text-slate-500">
        ...
        <a href="#audit" className="underline decoration-dotted underline-offset-4 hover:text-slate-700 dark:hover:text-slate-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500">Audit URL</a>
      </div>
      ...
      <ul className="mb-4 space-y-2 text-sm">
        ...
        <li className="flex items-center gap-2"><span className="size-1.5 rounded-full bg-sky-500" /><span>✓ Bias‑reducing, explainable rationale</span></li>
      </ul>
      ...
      {/* receipt edge - consistent perforation */}
    ...
    <section className="relative isolate overflow-hidden py-12 sm:py-20">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 lg:grid-cols-12">
        <div className="relative z-10 lg:col-span-6">
          ...
          <ul className="mt-6 grid max-w-md grid-cols-1 gap-2 text-sm text-slate-600 dark:text-slate-300">
            ...
            <li className="flex items-center gap-2"><span className="size-1.5 rounded-full bg-sky-500" />Gift codes welcomed • Community Pass available</li>
          </ul>
      ...
      <div className="mx-auto mt-12 max-w-7xl px-6">
        <div className="grid grid-cols-2 gap-4 rounded-2xl border border-slate-200 bg-white/70 p-4 text-sm shadow-sm backdrop-blur dark:border-slate-800 dark:bg-slate-950/40 sm:grid-cols-4">
          ...
          <div className="flex items-center gap-2"><span className="size-2 rounded-full bg-sky-500" />PPP Pricing</div>
