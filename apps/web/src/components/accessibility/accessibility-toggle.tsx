...
import { Eye, Focus, Keyboard, Settings, Type, Volume2 } from "lucide-react";
...
export function AccessibilityToggle({
    ...
    if (variant === "button") {
        return (
            <button
                ...
                aria-label={settings.highContrast
    ...
    if (variant === "panel") {
        return (
            <div
                className={`bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg p-4 ${className}`}
            >
                ...
                <div className="absolute bottom-16 right-0 w-80 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg shadow-xl p-4">
                    ...
                    <div className="mt-4 pt-3 border-t border-slate-200 dark:border-slate-700">
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                            Settings are saved locally and persist across
                            sessions.
                        </p>
                    </div>
                </div>
