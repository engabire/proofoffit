  ...
  const companyValues = [
    {
      ...
      description:
        "We believe in creating an inclusive workplace where everyone has equal opportunities to grow and succeed.",
    },
    {
      icon: <Eye className="h-8 w-8" />,
      title: "Transparency",
      description:
        "Open communication, clear feedback, and honest conversations are the foundation of our culture.",
    },
    {
      icon: <Brain className="h-8 w-8" />,
      title: "Continuous Learning",
      description:
        "We invest in your growth with learning budgets, conferences, and mentorship opportunities.",
    },
    {
      icon: <Heart className="h-8 w-8" />,
      title: "Work-Life Balance",
      description:
        "Flexible schedules, unlimited PTO, and remote-first culture support your well-being.",
    },
  ];
  ...
  const openPositions = [
    {
      ...
      description:
        "Join our core engineering team to build scalable, secure systems that power fair hiring decisions for millions of candidates worldwide.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Develop and deploy ML models that detect bias and ensure fair hiring practices across diverse candidate populations.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Lead product strategy and roadmap for our enterprise hiring platform, working closely with engineering and design teams.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Drive enterprise sales growth by building relationships with Fortune 500 companies and closing large deals.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Design intuitive, accessible interfaces that make complex hiring analytics understandable for all users.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Ensure customer satisfaction and drive adoption of our platform through proactive support and strategic guidance.",
      requirements: [
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 max-w-4xl mx-auto mb-8">
              Help us build the future of fair hiring. We&apos;re looking for
              passionate individuals who share our commitment to eliminating
              bias and creating equal opportunities for all.
            </p>
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 space-y-24">
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              We&apos;re building more than a company—we&apos;re creating a
              movement for fair hiring. Join a team that values diversity,
              transparency, and making a real impact.
            </p>
          </div>
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              ...
              and unique perks that support both personal and professional
              growth.
            </p>
          </div>
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              We believe in a fair, transparent hiring process that gives every
              candidate an equal opportunity to showcase their skills and
              potential.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300">
                Submit your application with resume and cover letter. We review
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300">
                Our team reviews your application and may reach out for a brief
                phone screening.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300">
                Technical interviews, culture fit discussions, and team
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300">
                We make our decision and extend an offer to the best candidate
                for the role.
              </p>
            </div>
          </div>
