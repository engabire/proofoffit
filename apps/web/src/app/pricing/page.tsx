...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'Yes. Provide EIN + org details during onboarding. Discounts apply once eligibility is verified—usually under three seconds.',
  },
]
...
export default function PricingPage() {
  ...
  const handleSubscribe = async (planId: string) => {
    ...
    if (!plan || plan.billing !== 'subscription') {
      console.error('Plan requires sales-assisted workflow.')
      return
    }
              ...
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    usage; Fund credits can reduce spend further for donor-backed programs.
                  </p>
