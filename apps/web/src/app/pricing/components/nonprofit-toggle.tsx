...
> = {
  N1: {
    ...
    multiplier: 0.5,
    discount: '50% off',
    summary: 'Community orgs / early nonprofits funded primarily by grants or donations.',
  },
  N2: {
    label: 'N2 • 51–250 FTE',
    multiplier: 0.65,
    discount: '35% off',
    summary: 'Regional nonprofits with dedicated talent teams and predictable programs.',
  },
  N3: {
    label: 'N3 • 251–1,000 FTE',
    multiplier: 0.75,
    discount: '25% off',
    summary: 'Multi-program organizations needing governance, SSO, and advanced reporting.',
  },
  N4: {
    label: 'N4 • 1,000+ FTE',
    multiplier: 0.9,
    discount: '10–30% off (deal desk)',
    summary: 'Global nonprofits with complex compliance; discount set with RevOps + funders.',
  },
}
        ...
        {Object.entries(tierDetails).map(([key, details]) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-xs text-blue-700/80">{details.summary}</span>
            </button>
          )
        })}
      </div>
