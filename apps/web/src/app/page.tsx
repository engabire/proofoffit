...
function SiteBackground(
  { variant = "neutral" }: { variant?: BackgroundVariant },
) {
  ...
  return (
    <>
      <div
        className={`absolute inset-0 z-0 bg-gradient-to-b from-white to-zinc-50 dark:from-zinc-950 dark:to-zinc-900`}
      />
      <motion.div
        aria-hidden
        className={`pointer-events-none absolute -top-32 -left-24 z-0 w-[40rem] h-[40rem] rounded-full blur-3xl opacity-60 bg-gradient-to-tr ${
          grads[0]
        } dark:opacity-50`}
      ...
      <motion.div
        aria-hidden
        className={`pointer-events-none absolute -bottom-24 -right-16 z-0 w-[36rem] h-[36rem] rounded-full blur-3xl opacity-60 bg-gradient-to-tr ${
          grads[1]
        } dark:opacity-50`}
...
const laneCopy = {
  ...
  employer: {
    ...
    label: "I'm Hiring",
    headline:
      "Shortlist faster—with explainable slates and audit-ready trails.",
    subhead:
...
const universalWhy = [
  ...
  },
  {
    ...
    body:
      "Every decision has a verifiable URL—great for stakeholders and compliance.",
    icon: <Lock className="h-5 w-5" aria-hidden />,
  },
  {
    title: "Smart Automation",
    body:
      "Tailored resumes and cover letters that echo the evidence, not fluff.",
...
const howSeeker = [
  {
    ...
    body: "Import resume, add projects, link evidence.",
  },
  {
    step: 2,
    title: "Pick a role",
    body: "We parse the JD and map it to your proof.",
  },
  {
    step: 3,
    title: "Get your Fit Report",
    body: "A 1‑pager you can attach, plus tailored resume/cover.",
  },
  {
    step: 4,
    title: "Apply with confidence",
    body: "Know your story before the recruiter call.",
  },
...
const howEmployer = [
  {
    step: 1,
    title: "Drop in a JD",
    body: "Define must‑haves vs nice‑to‑haves.",
  },
  {
    step: 2,
    title: "Receive a ranked slate",
    body: "Each candidate comes with a Fit Report and audit URL.",
  },
  {
    step: 3,
    title: "Decide faster",
    body: "Shareable evidence reduces meeting thrash.",
  },
  {
    step: 4,
    title: "Stay audit‑ready",
    body: "Immutable logs for fairness reviews.",
  },
] as { step: number; title: string; body: string }[];
...
const testimonials = {
  ...
  employer: [
    {
      quote:
        "We cut shortlist time dramatically. Debates turned into receipts we could compare.",
      name: "Priya N.",
      role: "Head of Talent",
    },
    {
      quote:
        "Legal loved the audit links. Hiring panels moved faster with less drama.",
      name: "Jordan K.",
      role: "HRBP",
    },
  ],
...
const pricing = {
  seeker: [
    {
      ...
      features: [
        ...
        "1 tailored resume/cover per week",
        "Fit Report Lite",
      ],
    ...
    },
    {
      ...
      features: [
        "All Pro features during sponsored period",
  ...
  employer: [
    ...
    },
    {
      ...
      highlight: true,
      footnote:
        "Cut time‑to‑shortlist by ~40% on average (verify before publishing)",
    },
  ],
};
...
function Header({ lane, setLane }: { lane: Lane; setLane: (l: Lane) => void }) {
  ...
  return (
    <>
      ...
      <header
        className={`sticky top-0 z-50 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-xl supports-[backdrop-filter]:bg-white/85 border-b border-slate-200/50 dark:border-slate-800/50 ${
          scrolled
        ...
        <div className="mx-auto max-w-7xl px-6 h-18 flex items-center justify-between">
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -inset-1 bg-gradient-to-br from-sky-500 to-indigo-600 rounded-xl opacity-0 group-hover:opacity-20 transition-opacity duration-200 blur-sm">
              </div>
            </div>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 pl-2 border-l border-slate-200 dark:border-slate-700">
              ...
              <Button
                asChild
                size="sm"
                className={`bg-gradient-to-r text-white shadow-lg hover:shadow-xl transition-all duration-200 font-medium px-6 ${
                  lane === "seeker"
                    ? "from-sky-500 to-indigo-600 hover:from-sky-600 hover:to-indigo-700"
              ...
              >
                <Link
                  ...
                  aria-label={`Get started with ProofOfFit - ${
                    lane === "seeker"
                      ? "Create your fit report"
                      : "Generate candidate slates"
                  }`}
                  rel="noopener"
                >
                  Get Started
              ...
              <SheetContent side="right" className="w-80">
                ...
                <div className="mt-6 flex flex-col gap-4">
                  ...
                  <a
                    ...
                    className="py-1 inline-flex items-center gap-2"
                  >
                    <Sparkles className={`h-4 w-4 ${lanePrimary}`} />{" "}
                    How It Works
                  </a>
                  <a
                    href="#pricing"
                      ...
                      <DropdownMenuTrigger asChild>
                        ...
                        >
                          <span className="inline-flex items-center gap-2">
                            <Globe2 className={`h-4 w-4 ${lanePrimary}`} />{" "}
                            Language
                          </span>
                          <ChevronDown className="h-3 w-3" />
                        </Button>
                  ...
                  <div>
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        ...
                        >
                          <span className="inline-flex items-center gap-2">
                            <HelpCircle className={`h-4 w-4 ${lanePrimary}`} />
                            {" "}
                            Help
                          </span>
                          <ChevronDown className="h-3 w-3" />
...
function LaneToggle(
  { lane, setLane }: { lane: Lane; setLane: (l: Lane) => void },
) {
  return (
    <div
      className="inline-flex rounded-xl border border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm shadow-sm p-1"
      role="tablist"
      aria-label="Audience"
    >
      {(["seeker", "employer"] as Lane[]).map((l) => {
        ...
        return (
          ...
          >
            ...
            {isActive && (
              <div className="absolute inset-0 bg-gradient-to-r from-sky-500/20 to-indigo-600/20 rounded-lg blur-sm">
              </div>
            )}
          </button>
        );
...
function ReceiptCard() {
  ...
  return (
    <Card className="w-full max-w-xl border-0 shadow-xl bg-white/70 dark:bg-zinc-900/60 backdrop-blur-xl ring-1 ring-white/50 dark:ring-white/10">
      ...
      <CardContent>
        <div
          className={`rounded-lg bg-zinc-50 dark:bg-zinc-900 p-4 ${receiptMono}`}
        >
          ...
          <ul className="mt-3 space-y-2">
            <li className="flex items-start gap-2">
              ...
              Matched: Python, orchestration, SOC2
            </li>
            <li className="flex items-start gap-2">
              <Check className="h-4 w-4 mt-0.5" />{" "}
              Signals: 2 portfolio proofs (GitHub, blog)
            </li>
            <li className="flex items-start gap-2">
              <Star className="h-4 w-4 mt-0.5" /> Stretch gap: Terraform
            </li>
            <li className="flex items-start gap-2">
              <ShieldCheck className="h-4 w-4 mt-0.5" />{" "}
              Bias‑reducing, explainable rationale
            </li>
          </ul>
          <div className="mt-3 flex items-center justify-between pt-2 border-t border-zinc-200 dark:border-zinc-800">
            <span className="inline-flex items-center gap-2">
              <Lock className="h-4 w-4" /> Audit URL
            </span>
            <button
            ...
            >
              <span className="truncate max-w-[12rem]" title={auditUrl}>
                {auditUrl}
              </span>
        ...
        <div className="rounded-[1.75rem] border border-white/70 bg-white/80 p-8 shadow-lg shadow-slate-200/40 backdrop-blur dark:border-white/10 dark:bg-slate-950/50">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.45em] text-slate-400">
                Inspired by the teams who set the bar
              </p>
              <h2 className="mt-2 font-serif text-2xl text-slate-900 dark:text-white">
                Beauty, utility, and approachability in one operating system.
              </h2>
            </div>
            <p className="max-w-sm text-sm text-slate-500 dark:text-slate-300">
              We blend calm authority, robust trust scaffolding, professional
              warmth, and intuitive approachability into every interaction.
            </p>
          </div>
          <div className="mt-6 grid gap-3 text-sm font-medium text-slate-600 dark:text-slate-300 sm:grid-cols-5">
            {inspirationBrands.map((brand) => (
              <div
                key={brand.name}
                className="rounded-xl border border-white/70 bg-slate-50/70 px-4 py-3 text-center shadow-sm shadow-slate-200/40 dark:border-white/10 dark:bg-slate-900/60"
              >
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-7 grid gap-4 sm:grid-cols-2">
            {aiHighlights.map((item) => (
              <Card
                key={item.title}
                className="group h-full border border-white/70 bg-white/85 shadow-sm shadow-slate-200/40 transition hover:-translate-y-0.5 hover:shadow-lg hover:shadow-slate-200/50 dark:border-white/10 dark:bg-slate-950/60 dark:hover:shadow-none"
              >
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          {universalWhy.map((w, i) => (
            <Card
              key={i}
              className="h-full border border-white/70 bg-white/85 shadow-sm shadow-slate-200/30 backdrop-blur transition hover:-translate-y-0.5 hover:shadow-lg hover:shadow-slate-200/40 dark:border-white/10 dark:bg-slate-950/60"
            >
...
function HowItWorks(
  { items, lane }: {
    items: { step: number; title: string; body: string }[];
    lane: Lane;
  },
) {
  return (
    <section id="how" className="relative overflow-hidden py-16">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 -top-24 mx-auto h-64 max-w-4xl rounded-full bg-gradient-to-r from-sky-200/40 via-indigo-200/30 to-emerald-200/30 blur-3xl dark:from-sky-500/20 dark:via-indigo-500/20 dark:to-emerald-500/20"
      />
              ...
              <Card className="h-full border border-white/70 bg-white/85 shadow-sm shadow-slate-200/30 backdrop-blur transition hover:-translate-y-0.5 hover:shadow-lg hover:shadow-slate-200/40 dark:border-white/10 dark:bg-slate-950/60">
                <CardHeader className="pb-0">
                  <CardTitle className="font-semibold text-slate-900 dark:text-slate-100">
                    <span className="mr-2 inline-flex size-7 items-center justify-center rounded-full bg-sky-100 text-xs font-semibold text-sky-600 dark:bg-sky-900/40 dark:text-sky-200">
                      {s.step}
                    </span>
                    {s.title}
                  </CardTitle>
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-8 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-2 font-serif text-3xl text-slate-900 dark:text-white">
              Simple tiers for individuals and teams.
            </h2>
          </div>
          <p className={`max-w-md text-sm ${subtle}`}>
            Cancel anytime. Crafted with PPP affordability and sponsor pools so
          ...
          {plans.map((p, i) => (
            <Card
              ...
              className={`relative h-full border border-white/70 bg-white/85 shadow-md shadow-slate-200/40 backdrop-blur transition hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-200/50 dark:border-white/10 dark:bg-slate-950/60 ${
                (p as any).highlight
                  ? "ring-1 ring-sky-300/70 dark:ring-sky-500/40"
                  : ""
              }`}
            >
              {(p as any).highlight && (
                <Badge
                  className="absolute -top-3 right-4 rounded-full bg-sky-500 text-xs text-white shadow"
                  variant="default"
                >
                  Most loved
                </Badge>
...
function DMTestimonials({ lane }: { lane: Lane }) {
  ...
  return (
    <section className="relative overflow-hidden py-16" id="stories">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 top-1/2 h-64 -translate-y-1/2 bg-gradient-to-r from-sky-200/35 via-indigo-200/25 to-emerald-200/25 blur-3xl dark:from-sky-500/20 dark:via-indigo-500/20 dark:to-emerald-500/20"
      />
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {items.map((t, index) => (
            <Card
              key={index}
              className="border border-white/70 bg-white/85 shadow-md shadow-slate-200/40 backdrop-blur transition hover:-translate-y-0.5 hover:shadow-xl hover:shadow-slate-200/50 dark:border-white/10 dark:bg-slate-950/60"
            >
...
function GiftSponsorPanel() {
  ...
  const handleRedeem = async () => {
    ...
    try {
      ...
      const until = payload?.currentPeriodEnd
        ? new Date(payload.currentPeriodEnd)
        : null;
      setStatus("success");
      setMessage(
        until
          ? `Gift applied. Access runs through ${until.toLocaleDateString()}.`
      ...
      setStatus("error");
      setMessage(
        "Something went wrong redeeming this code. Please try again or contact support.",
      );
    } finally {
      setRedeeming(false);
    }
    ...
    <Card className="border border-white/70 bg-gradient-to-br from-white/90 via-white/85 to-sky-50/80 shadow-md shadow-slate-200/40 backdrop-blur dark:border-white/10 dark:from-slate-950/70 dark:via-slate-950/60 dark:to-slate-900/60">
      <CardHeader className="pb-3">
        <CardTitle className="flex items-center gap-2 text-base text-slate-900 dark:text-slate-100">
          <Gift className="h-4 w-4" /> Gift &amp; Sponsor
        </CardTitle>
        <CardDescription className="text-sm text-slate-500 dark:text-slate-300">
          Redeem a community pass or sponsor someone else’s search.
        </CardDescription>
      </CardHeader>
      <CardContent className="grid gap-4 md:grid-cols-[minmax(0,1fr),220px]">
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Codes typically cover 1–3 months of ProofOfFit Pro. No card
            required.
          </p>
          {message && (
            <p
        ...
        <div className="space-y-2 rounded-2xl border border-white/60 bg-white/85 p-4 shadow-sm shadow-slate-200/40 dark:border-white/10 dark:bg-slate-950/60">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Gift-proof someone’s search for $12/month. We handle delivery and
            receipts.
          </p>
          <Button
            size="sm"
    ...
    <footer className="mt-16 border-t border-white/70 bg-white/80 backdrop-blur dark:border-white/10 dark:bg-slate-950/70">
      <div className="mx-auto max-w-7xl px-6 py-14">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.6fr),repeat(3,minmax(0,1fr))]">
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a
                aria-label="Twitter"
                href="https://x.com/proofoffit"
                className="rounded-xl border border-white/70 p-2 text-slate-500 transition hover:bg-white/60 dark:border-white/10 dark:text-slate-300 dark:hover:bg-slate-900/60"
              >
                <Twitter className="h-4 w-4" />
              </a>
              <a
                aria-label="LinkedIn"
                href="https://www.linkedin.com/company/proofoffit"
                className="rounded-xl border border-white/70 p-2 text-slate-500 transition hover:bg-white/60 dark:border-white/10 dark:text-slate-300 dark:hover:bg-slate-900/60"
              >
              ...
              <a
                aria-label="GitHub"
                href="https://github.com/proofoffit"
                className="rounded-xl border border-white/70 p-2 text-slate-500 transition hover:bg-white/60 dark:border-white/10 dark:text-slate-300 dark:hover:bg-slate-900/60"
              >
        ...
        <div className="mt-10 flex flex-col gap-4 border-t border-white/60 pt-6 text-sm text-slate-500 dark:border-white/10 dark:text-slate-400 md:flex-row md:items-center md:justify-between">
          <span>
            © 2024 ProofOfFit, Inc. Crafted with transparency in Buffalo, MN,
...
export default function ProofOfFitLanding() {
  ...
  return (
    <div className={warmBody}>
      ...
      <WhyChoose />
      <HowItWorks
        items={lane === "seeker" ? howSeeker : howEmployer}
        lane={lane}
      />
      <Pricing lane={lane} />
