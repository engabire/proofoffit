  ...
  const contactOptions = [
    {
      ...
      description:
        "Ready to transform your hiring process? Contact our enterprise team for custom solutions.",
    ...
    },
    {
      ...
      description:
        "Questions about our platform, features, or need technical assistance?",
    ...
    },
    {
      title: "Media & Press",
      description:
        "Press inquiries, media resources, and partnership opportunities.",
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 max-w-4xl mx-auto mb-8">
              ...
              you get started with fair, transparent, and bias-free hiring
              solutions.
            </p>
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 space-y-24">
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              Choose the right contact option for your needs. Our specialized
              ...
              <Card className="bg-gradient-to-r from-blue-600 to-purple-600 text-white border-0">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm opacity-90 mb-4">
                    For urgent technical issues or enterprise support, call us
                    directly.
                  </p>
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              Visit us at one of our locations worldwide. We&apos;re always
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              Our team is available during these hours to provide the best
              support experience.
            </p>
          </div>
