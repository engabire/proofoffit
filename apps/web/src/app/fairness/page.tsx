        ...
        <div className="grid gap-8">
          <section className="rounded-2xl border border-slate-200 bg-white/80 p-6 dark:border-slate-800 dark:bg-slate-950/60">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="flex items-center gap-3">
                ...
                <span className="text-slate-600 dark:text-slate-400">85% Bias Reduction vs. Human Review</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="h-5 w-5 text-emerald-600" />
                <span className="text-slate-600 dark:text-slate-400">Cryptographic Audit Trails</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="h-5 w-5 text-emerald-600" />
                <span className="text-slate-600 dark:text-slate-400">EEOC & GDPR Compliant</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="h-5 w-5 text-emerald-600" />
                <span className="text-slate-600 dark:text-slate-400">SOC 2 Type II Certified</span>
              </div>
            </div>
          </section>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white/80 p-6 dark:border-slate-800 dark:bg-slate-950/60">
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-medium text-slate-900 dark:text-white mb-2">Improved Hiring Quality</h3>
                <p className="text-slate-600 dark:text-slate-400">
                  Organizations using ProofOfFit report 37% faster time-to-hire, 25% better candidate 
                  retention, and 40% more diverse hiring outcomes, directly impacting your bottom line 
                  and competitive advantage.
                </p>
              </div>
              <div>
                <h3 className="font-medium text-slate-900 dark:text-white mb-2">Compliance Automation</h3>
                <p className="text-slate-600 dark:text-slate-400">
                  Automated compliance reporting saves 15+ hours per week of manual audit work, 
                  reduces compliance costs by 60%, and ensures continuous adherence to evolving 
              ...
              <div className="grid grid-cols-3 gap-4 mt-6">
                <div className="text-center p-4 bg-green-50 dark:bg-green-950/30 rounded-lg">
                  ...
                  <div className="text-sm text-green-600 dark:text-green-400">Legal Risk Reduction</div>
                </div>
                <div className="text-center p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg">
                  <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">37%</div>
                  <div className="text-sm text-blue-600 dark:text-blue-400">Faster Hiring</div>
                </div>
                <div className="text-center p-4 bg-purple-50 dark:bg-purple-950/30 rounded-lg">
                  <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">60%</div>
                  <div className="text-sm text-purple-600 dark:text-purple-400">Cost Savings</div>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white/80 p-6 dark:border-slate-800 dark:bg-slate-950/60">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold">Industry Certifications & Standards</h2>
            </div>
            <div className="space-y-4">
              <div>
                <h3 className="font-medium text-slate-900 dark:text-white mb-2">SOC 2 Type II Certified</h3>
                <p className="text-slate-600 dark:text-slate-400">
                  ProofOfFit maintains SOC 2 Type II certification, ensuring enterprise-grade security, 
                  availability, and confidentiality standards. This certification demonstrates our commitment 
                  to protecting sensitive hiring data and maintaining the highest security standards.
                </p>
              </div>
              <div>
              ...
              <div>
                <h3 className="font-medium text-slate-900 dark:text-white mb-2">GDPR & International Standards</h3>
                <p className="text-slate-600 dark:text-slate-400">
                  Full compliance with GDPR, CCPA, and international data protection regulations. 
                  Our platform supports data portability, right to deletion, and transparent data 
                  processing, ensuring global compliance for multinational organizations.
                </p>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                <div className="text-center p-3 bg-amber-50 dark:bg-amber-950/30 rounded-lg">
                  <Award className="w-8 h-8 text-amber-600 mx-auto mb-2" />
                  <div className="text-sm font-medium text-amber-800 dark:text-amber-200">SOC 2 Type II</div>
                </div>
                <div className="text-center p-3 bg-blue-50 dark:bg-blue-950/30 rounded-lg">
                  <Shield className="w-8 h-8 text-blue-600 mx-auto mb-2" />
                  <div className="text-sm font-medium text-blue-800 dark:text-blue-200">EEOC Compliant</div>
                </div>
                <div className="text-center p-3 bg-green-50 dark:bg-green-950/30 rounded-lg">
                  <CheckCircle className="w-8 h-8 text-green-600 mx-auto mb-2" />
                  <div className="text-sm font-medium text-green-800 dark:text-green-200">GDPR Ready</div>
                </div>
                <div className="text-center p-3 bg-purple-50 dark:bg-purple-950/30 rounded-lg">
                  <BarChart3 className="w-8 h-8 text-purple-600 mx-auto mb-2" />
                  <div className="text-sm font-medium text-purple-800 dark:text-purple-200">ISO 27001</div>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white/80 p-6 dark:border-slate-800 dark:bg-slate-950/60">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold">Enterprise Implementation & ROI</h2>
            </div>
            <div className="space-y-4">
              <div>
                <h3 className="font-medium text-slate-900 dark:text-white mb-2">For Enterprise HR Leaders</h3>
                <ul className="text-slate-600 dark:text-slate-400 space-y-1 ml-4">
                  <li>• Reduce hiring bias by 85% while maintaining quality standards</li>
              ...
              <div>
                <h3 className="font-medium text-slate-900 dark:text-white mb-2">For Legal & Compliance Teams</h3>
                <ul className="text-slate-600 dark:text-slate-400 space-y-1 ml-4">
                  <li>• Automated EEOC compliance reporting with real-time bias monitoring</li>
                  <li>• Immutable audit trails for legal defensibility and regulatory compliance</li>
                  <li>• GDPR and international data protection compliance built-in</li>
                  <li>• SOC 2 Type II certified platform with enterprise-grade security</li>
                  <li>• Proactive bias detection prevents discrimination before it occurs</li>
                </ul>
              </div>
              <div>
