  ...
  const leadership = [
    {
      ...
      role: "CEO & Co-Founder",
      bio:
        "Former VP of Engineering at Palantir, PhD in Computer Science from Stanford. Led development of bias-detection algorithms for government applications.",
    ...
    },
    {
      ...
      role: "CTO & Co-Founder",
      bio:
        "Former Staff Engineer at major tech companies, specializing in large-scale ML systems. Led teams building diversity analytics platforms.",
    ...
    },
    {
      ...
      bio:
        "Leading researcher in algorithmic fairness and bias mitigation. Former Principal Scientist at Microsoft Research, 50+ peer-reviewed publications.",
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 max-w-4xl mx-auto mb-8">
              We&apos;re building the future of fair hiring through transparent
              evidence engines, rigorous auditing, and enterprise-grade
              security. Trusted by 500+ companies worldwide.
            </p>
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 space-y-24">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <Card className="border-blue-200 bg-blue-50/50 dark:border-blue-800 dark:bg-blue-950/20">
              <CardContent className="p-8">
                ...
                <p className="text-slate-600 dark:text-slate-300">
                  To eliminate bias from hiring decisions through transparent
                  evidence engines, rigorous auditing, and enterprise-grade
                  security. We believe every candidate deserves a fair chance to
                  prove their fit.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-purple-200 bg-purple-50/50 dark:border-purple-800 dark:bg-purple-950/20">
              <CardContent className="p-8">
                ...
                <p className="text-slate-600 dark:text-slate-300">
                  A world where hiring decisions are made on merit alone, where
                  every algorithm is explainable, and where talent is recognized
                  regardless of background. Building the infrastructure for fair
                  hiring at scale.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="space-y-4 text-slate-600 dark:text-slate-300">
                <p>
                  ProofOfFit was founded in 2021 by Sarah Chen and Marcus
                  Rodriguez, former engineers from Palantir and major tech
                  companies who experienced firsthand how unconscious bias
                ...
                <p>
                  ...
                  about creating provable, auditable processes.
                </p>
                <p>
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              Enterprise-grade security and compliance certifications that
              protect your data and ensure regulatory compliance.
            </p>
          </div>
        ...
        <section>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto">
              Ready to transform your hiring process? Contact our team to learn
              more.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <a
                  href="mailto:hello@proofoffit.com"
            ...
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <a
                  href="mailto:press@proofoffit.com"
          ...
          <Card className="bg-gradient-to-r from-blue-600 to-purple-600 text-white border-0">
            <CardContent className="p-12">
              ...
              <p className="text-xl mb-8 opacity-90">
                Join 500+ companies already using ProofOfFit to make fairer,
