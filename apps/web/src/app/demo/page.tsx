...
export default function DemoPage() {
  ...
  const getBreadcrumbItems = () => [
    ...
    {
      label: activeTab === "fit-report" ? "Job Seeker Demo" : "Employer Demo",
      current: true,
    },
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Experience ProofOfFit&apos;s bias-reducing, explainable matching in
            action. See how we create fair, transparent hiring decisions with
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <Button
              onClick={() => {
                const otherTab = activeTab === "fit-report"
                  ? "candidate-slate"
                  : "fit-report";
                      ...
                      <CardContent className="p-6">
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {["Kubernetes", "GraphQL", "Leadership"].map((
                                skill,
                              ) => (
                          ...
                          <div className="flex items-start">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-blue-800 text-sm mt-4">
                                This analysis was conducted using bias-reducing
                                algorithms that focus on skills, experience, and
                                qualifications while minimizing unconscious bias
                                factors.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-gray-700 text-sm mt-4">
                                Every decision is cryptographically verified and
                                cannot be altered. This ensures complete
                                transparency and compliance with hiring
                                regulations.
                              </p>
                            </div>
                          </div>
                ...
                <div className="mb-6 flex justify-between items-center p-4 bg-emerald-50 rounded-lg">
                  <div className="flex items-center space-x-2 text-sm text-emerald-700">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-auto p-1 text-emerald-600 hover:text-emerald-800"
                    >
                      Requirements
                    </Button>
                    <ChevronRight className="w-3 h-3" />
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        },
                        {
                          ...
                          company: "StartupXYZ",
                          diversity: "Male, African-American",
                        },
                        {
                          name: "Alex Rodriguez",
                          score: 78,
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-emerald-800 text-sm mt-4">
                            This slate was generated using bias-reducing
                            algorithms and maintains an immutable audit trail.
                            All selection decisions are explainable and
                            verifiable.
                          </p>
                        </div>
                      </div>
        ...
        <div className="text-center mt-12">
          <h2 className="text-2xl font-bold mb-4">
            Ready to Experience ProofOfFit?
          </h2>
          <p className="text-gray-600 mb-6">
            Join thousands of job seekers and employers who trust ProofOfFit for
