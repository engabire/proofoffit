...
describe("Claim Citation Validation", () => {
  ...
  test("should accept valid claims with citations", () => {
    const validClaim = "I have experience with React [#proof-1] and Node.js [#proof-2].";
    
    expect(() => validateClaimCitations(validClaim, allowedProofIds)).not.toThrow();
  });
  ...
  test("should reject claims with unauthorized citations", () => {
    const invalidClaim = "I have experience with React [#proof-1] and Python [#unauthorized-proof].";
  ...
  test("should handle multiple sentences", () => {
    const multiSentenceClaim = "I have experience with React [#proof-1]. I also know Node.js [#proof-2].";
    
    expect(() => validateClaimCitations(multiSentenceClaim, allowedProofIds)).not.toThrow();
  });

  test("should reject if any sentence lacks citations", () => {
    const mixedClaim = "I have experience with React [#proof-1]. I also know Node.js.";
  ...
  test("should handle edge cases", () => {
    const emptyClaim = "";
    expect(() => validateClaimCitations(emptyClaim, allowedProofIds)).not.toThrow();
