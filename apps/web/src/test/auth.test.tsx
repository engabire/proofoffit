...
describe('Authentication Flow', () => {
  ...
  expect(screen.getByRole('button', { name: /create account/i })).toBeInTheDocument()
    ...
    it('shows validation errors for invalid email and password on sign up', () => {
      ...
      expect(alerts.some(a => /enter a valid email address/i.test(a.textContent || ''))).toBeTruthy()
      expect(alerts.some(a => /password must be at least 8 characters/i.test(a.textContent || ''))).toBeTruthy()
    })
