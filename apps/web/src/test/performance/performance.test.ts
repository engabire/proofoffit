...
describe("Performance Monitoring Tests", () => {
    ...
    describe("Performance Recommendations", () => {
        it("should generate LCP recommendations", () => {
            ...
            const recommendations = performanceMonitor
    ...
    describe("Performance Measurement Utilities", () => {
        ...
        it("should handle errors in async measurements", async () => {
            const mockAsyncOperation = vi.fn().mockRejectedValue(
                new Error("Test error"),
            );

            await expect(measureAsync("test-error", mockAsyncOperation)).rejects
                .toThrow("Test error");
        ...
        it("should handle errors in sync measurements", () => {
            ...
            expect(() => measureSync("test-error", mockSyncOperation)).toThrow(
                "Test error",
            );
