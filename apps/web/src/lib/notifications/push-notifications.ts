...
export const subscribeToNotifications = () => pushNotificationManager.subscribe();
export const unsubscribeFromNotifications = () => pushNotificationManager.unsubscribe();
export const showNotification = (payload: NotificationPayload) => pushNotificationManager.showNotification(payload);
export const getNotificationPermission = () => pushNotificationManager.getPermissionStatus();
export const isNotificationSubscribed = () => pushNotificationManager.isSubscribed();
