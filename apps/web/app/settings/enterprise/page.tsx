    ...
    const checkAuth = async () => {
      try {
        ...
        if (token && user) {
          ...
          router.push(
            "/auth/signin?redirect=/settings/enterprise&type=employer",
          );
        }
      } catch (error) {
        // eslint-disable-next-line no-console
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage your organization&apos;s ProofOfFit configuration
          </p>
        </div>
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm text-gray-900">
                        New user John Doe joined via Okta SSO
                      </p>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm text-gray-900">
                        Sarah Johnson updated company settings
                      </p>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm text-gray-900">
                        New job posting created: Senior Developer
                      </p>
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {provider.type.toUpperCase()} • {provider.users}
                            {" "}
                            users
                          </p>
                        </div>
