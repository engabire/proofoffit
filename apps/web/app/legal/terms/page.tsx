        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none">
                ...
                <section className="mb-8">
                    ...
                    <p className="mb-4">
                        By accessing and using ProofOfFit, you accept and agree
                ...
                <section className="mb-8">
                    ...
                    <p className="mb-4">
                        ...
                        of ProofOfFit for personal, non-commercial transitory
                        viewing only.
                    </p>
                </section>
                ...
                <section className="mb-8">
                    ...
                    <p className="mb-4">
                        In no event shall ProofOfFit or its suppliers be liable
                        for any damages arising out of the use or inability to
                        use the materials on ProofOfFit.
                    </p>
                </section>
