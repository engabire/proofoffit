      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <header className="mb-8">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400">
            This page demonstrates the high-contrast theme and other accessibility features.
          </p>
        </header>

        {/* Current Settings Display */}
        <div className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Current Accessibility Settings</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className={`p-3 rounded-md border-2 ${
              ...
              <div className="text-sm">{settings.highContrast ? 'ON' : 'OFF'}</div>
            </div>
            <div className={`p-3 rounded-md border-2 ${
              ...
              <div className="text-sm">{settings.reducedMotion ? 'ON' : 'OFF'}</div>
            </div>
            <div className={`p-3 rounded-md border-2 ${
              settings.largeText 
              ...
              <div className="text-sm">{settings.largeText ? 'ON' : 'OFF'}</div>
            </div>
            <div className={`p-3 rounded-md border-2 ${
              ...
              <div className="text-sm">{settings.screenReader ? 'ON' : 'OFF'}</div>
            </div>
            <div className={`p-3 rounded-md border-2 ${
              ...
              <div className="text-sm">{settings.keyboardNavigation ? 'ON' : 'OFF'}</div>
            </div>
            <div className={`p-3 rounded-md border-2 ${
              ...
              <div className="text-sm">{settings.focusVisible ? 'ON' : 'OFF'}</div>
            </div>
          </div>
        </div>
        ...
        {/* Theme Toggle Panel */}
        <div className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">Accessibility Controls</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-4">Button Examples</h3>
        ...
        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400">
              This is a large paragraph text that should be clearly readable in both normal and high-contrast modes.
            </p>
            <p className="text-base text-slate-600 dark:text-slate-400">
              This is regular paragraph text that should maintain good contrast and readability.
            </p>
            <p className="text-sm text-slate-500 dark:text-slate-500">
              This is small text that should still be readable in high-contrast mode.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
          ...
          <ul className="text-blue-800 dark:text-blue-200 space-y-2">
            <li>• Use the floating accessibility button in the bottom-right corner</li>
            <li>• Toggle "High contrast mode" to see the visual changes</li>
            <li>• Check that all text remains readable with high contrast</li>
            <li>• Verify that buttons and form elements are clearly visible</li>
            <li>• Test that the color palette maintains sufficient contrast</li>
