...
export const GET = withAuditLogging(
    async (req: NextRequest, { params }: { params: { id: string } }) => {
        try {
            ...
            const application = applicationTracker.getApplication(
                applicationId,
            );
    ...
    async (req: NextRequest, { params }: { params: { id: string } }) => {
        try {
            ...
            switch (action) {
                ...
                case "add-document":
                    updatedApplication = applicationTracker.addDocument(
                        applicationId,
                        data.document,
                    );
                    break;
                ...
                case "schedule-interview":
                    updatedApplication = applicationTracker.scheduleInterview(
                        applicationId,
