...
import { Link, Share, BarChart3, FileText, Eye } from "lucide-react";
                    ...
                    <div key={proof.id} className="flex items-start justify-between p-4 border border-gray-200 rounded-lg">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          ...
                          {proof.url && (
                            <Link href={proof.url} target="_blank" rel="noopener noreferrer" className="text-xs text-blue-600 hover:underline">
                              View Evidence
                            </Link>
                          )}
                        </div>
