...
The ProofOfFit Team`;
    ...
    const mailtoLink = `mailto:?subject=${encodeURIComponent(subject)}&body=${
  ...
  const handleShareSocial = (platform: string) => {
    const text =
      `I just gifted ${months} months of ProofOfFit Pro to help someone land their dream job! 🎁 #ProofOfFit #JobSearch`;
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-6">
            You&apos;ve gifted{" "}
            <span className="font-semibold text-blue-600">{months} months</span>
            {" "}
            of ProofOfFit Pro to{" "}
            <span className="font-semibold">{recipient}</span>
          </p>
          <p className="text-gray-600">
            They&apos;ll receive an email with their gift code and instructions
            to get started.
          </p>
        </div>
        ...
        <div className="mt-8 text-center">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6">
            ...
            <p className="text-gray-600 mb-4">
              Consider gifting ProofOfFit Pro to other job seekers in your
              network.
            </p>
            <button
