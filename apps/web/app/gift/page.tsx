...
export default function GiftPage() {
  ...
  const selectedGift = giftOptions.find((option) =>
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      router.push(
        `/gift/success?months=${selectedGift?.months}&recipient=${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Give the gift of evidence-based job matching. Help a job seeker get
            tailored resumes, cover letters, and fit analysis that leads to more
            interviews.
          </p>
        </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              >
                ...
                <div className="flex items-start space-x-2 text-sm text-gray-600">
                  ...
                  <span>
                    Your payment is secure and encrypted. The recipient will
                    receive their gift via email within 24 hours of purchase.
                  </span>
                </div>
              </form>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Help them get detailed fit reports that explain exactly why they
                match each role.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our users see a significant increase in interview rates within
                30 days.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Tailored resumes, cover letters, and interview preparation
                materials.
              </p>
            </div>
          </div>
