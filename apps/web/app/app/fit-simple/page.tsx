...
export default function SimpleFitPage() {
  ...
  // Active tab
  const [activeTab, setActiveTab] = useState<"search" | "analyze" | "apply">(
    "search",
  );
    ...
    const sampleJobs: Job[] = [
      {
        ...
        description:
          "We are looking for a Senior Frontend Developer to join our growing team. You will be responsible for building and maintaining our web applications using React, TypeScript, and modern frontend technologies.",
        requirements: [
      ...
      },
      {
        ...
        description:
          "Join our fast-growing startup as a Full Stack Engineer. You will work on both frontend and backend systems, building scalable web applications and APIs.",
        requirements: [
      ...
      },
      {
        ...
        description:
          "We are seeking a talented React Developer to work on various client projects. You will collaborate with designers and backend developers to create exceptional user experiences.",
        requirements: [
      ...
      const mockAnalysis: AnalysisResult = {
        ...
        strengths: [
          `Strong experience with ${
            job.requirements[0]?.split(" ")[0] || "relevant technologies"
          }`,
        ...
        gaps: [
          job.requirements.find((req) => req.includes("certification")) ||
          "Specific certification mentioned in requirements",
          job.requirements.find((req) => req.includes("years")) ||
          "Additional years of experience in specific area",
...
Experienced software developer with 5+ years of expertise in ${
        selectedJob.requirements[0]?.split(" ")[0] || "modern web technologies"
      }. Proven track record of delivering high-quality, scalable applications and leading development teams.
...
I am writing to express my strong interest in the ${selectedJob.title} position at ${selectedJob.company}. With my extensive experience in ${
        selectedJob.requirements[0]?.split(" ")[0] || "software development"
      } and proven track record of delivering high-quality solutions, I am confident that I would be a valuable addition to your team.
...
- The role aligns perfectly with my expertise in ${
        selectedJob.requirements[0]?.split(" ")[0] || "relevant technologies"
      }
...
John Doe`;
  ...
  const handleDownloadResume = () => {
    ...
    a.href = url;
    a.download = `${
      selectedJob?.title.replace(/\s+/g, "_")
    }_tailored_resume.md`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Find opportunities, analyze your fit, and generate tailored
            applications
          </p>
        </div>
              ...
              ? (
                <div className="bg-white rounded-lg shadow-sm border p-12">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">
                      We&apos;re analyzing how well you match this position...
                    </p>
                  </div>
                </div>
              )
                ...
                <div className="bg-white rounded-lg shadow-sm border p-12">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-4">
                      Click &ldquo;Analyze Fit&rdquo; on a job listing to see
                      how well you match the position.
                    </p>
                    <button
                      onClick={() => setActiveTab("search")}
                      className="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 transition-colors"
            ...
            {analysis && (
              <div className="bg-white rounded-lg shadow-sm border p-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Generate a tailored resume and cover letter for this
                    position.
                  </p>
                  <button
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Download your tailored materials and apply directly to the
                  position.
                </p>
