      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Monitoring & Testing</h1>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Offline & Install</p>
                  </div>
                </div>
                <Badge variant={getStatusColor(systemStatus.pwa)}>
                  {systemStatus.pwa}
                </Badge>
              </div>
            </CardContent>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                ...
                <Badge variant={getStatusColor(systemStatus.analytics)}>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                ...
                <Badge variant={getStatusColor(systemStatus.testing)}>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Core Web Vitals scores improved by 15%</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 p-3 bg-yellow-50 rounded-lg">
                      <AlertTriangle className="h-4 w-4 text-yellow-500" />
                      <div>
                        <p className="text-sm font-medium">High LCP Detected</p>
                        <p className="text-xs text-gray-600">Largest Contentful Paint exceeded 2.5s</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                      <Zap className="h-4 w-4 text-blue-500" />
                      <div>
                        <p className="text-sm font-medium">PWA Tests Passed</p>
                        <p className="text-xs text-gray-600">All PWA features working correctly</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
